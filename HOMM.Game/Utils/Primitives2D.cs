...
namespace HOMM.Game.Utils
{
    public static class Primitives2D
	{
		...
		public static void FillRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, float angle)
		{
			...
			spriteBatch.Draw(pixel, rect, null, color, angle, Vector2.Zero, SpriteEffects.None, 1.0f);
		}
		...
		public static void PutPixel(this SpriteBatch spriteBatch, Vector2 position, Color color, float layerDepth = 1.0f)
		{
			if (pixel == null)
			{
				CreateThePixel(spriteBatch);
			...
			spriteBatch.Draw(pixel, position, null, color, 0.0f, Vector2.Zero, 1.0f, SpriteEffects.None, layerDepth);
		}
